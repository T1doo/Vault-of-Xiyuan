...
当前作业和唯一监督runner/训练PID、实际GPU、deadline与命令保存在本机S-500 run的orchestration.json及result-registration；原F2六checkpoint、原SA/SB实验、有效/失效评测和中期诊断缺口均保留。S尚未形成1000步完整恢复点，当前不能声称可精确恢复到最新heartbeat；下一完整计划保存点1000。
